  ...
  return (
    <div className="content">
      ...
      <span className="headp">
        {" "}
        <span>&#8594;</span>JEE Solutions
      </span>

      <div className="topicwise d-flex flex-column">
        <span className="topich">Chapter 1</span>
        <div className="topicwise-content  d-flex flex-column flex-md-row justify-content-around">
          <a
      ...
      <div className="topicwise d-flex flex-column">
        <span className="topich">Chapter 3</span>
        <div className="topicwise-content  d-flex flex-column flex-md-row justify-content-around">
          <a
            href="https://docs.google.com/document/d/1vzpKz5fjZabAEq1o2P9FX21nwtvwIoEfHmi0jzXSRdA/edit?usp=drive_link"
            className="pdf-tile"
